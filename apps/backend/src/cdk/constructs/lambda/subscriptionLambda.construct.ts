...
export type SubscriptionLambdaProps = {
    subscriptionTable: SubscriptionTable;
    onlineTable: OnlineTable;
    notificationQueue: EventQueue;
}

export class SubscriptionLambda extends NodejsFunction {
    constructor(scope: Construct, id: string, props: SubscriptionLambdaProps) {
        super(scope, id, {
            entry: path.join(__dirname, '..', '..', '..', 'handlers', 'subscriptionHandler.ts'),
